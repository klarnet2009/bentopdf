/*
 * coherentpdf.global.d.ts — TypeScript type definitions for ITERUM PDF / CoherentPDF integration
 *
 * These type definitions were written by Alam for use in the ITERUM PDF project.
